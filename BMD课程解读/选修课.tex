...
这门课是在第四学期之后的两个星期进行，需要提前很久发邮件报名注册才有名额（但基本报不满）。除非对这个课题或自行车运动非常感兴趣，否则不建议选择，有这个时间不如准备可能的补考或者开始暑假，这门课的设计比较失败，感觉学不到什么，实验本身不如选择其他设计类课程，更规范并且课程安排更加合理。

这门课分为上课和做Project,上课的大部分内容并没有实际作用，都是非常粗浅的介绍，而且很多内容与BMD的其他课程内容有一定重复。由于是来自不同学校，不同专业的学生和老师，实际上课程所教授内容并不具有整体性和连贯性，更像是综述介绍研究成果最后凑在一起。Project的内容为预测测试者在赛道上的表现（特定场景下完成指定距离的时间等）并在最后一天进行实地测试并比较。
\begin{flushright}
张先治/熊俊彦; 15/07/2023
\end{flushright}
...
该课主要概述了机器人的运动规划，就本人而言感觉这是一门对该领域很好的入门课，对于想研究（BIO）Robotics的同学是一门不错的课。这门课的授课质量，知识型，有趣性，作业布置都属上乘，美中不足的是课程前期讲得很快，对机器人领域不了解的小伙伴听起来会很吃力，而且老师的西班牙口音稍微有点重，所以我在最开始几周基本没听懂。
...
\subsection{RO47015 Applied Experimental Method}\hypertarget{RO47015}{} 
\begin{minipage}{0.45\textwidth}
\centering
\begin{tikzpicture}
\begin{polaraxis}[
...
这门课是Robo那边的HRI方向大老板组织的课，和必修课Human Robot Interaction关联性还是蛮高的。就如课程名字所述的那样，课程本身不会涉及什么新的知识点，主要就是在七八周内选一个迷你课题，设计，实验，分析，答辩并写一篇相对简短规范的论文报告。

我个人很推荐这门课的原因之一：师生比非常高，整体体验会非常好。HRI大老板下面的几乎所有老师都会过来，第一节课老师们会给出不同的方向进行选择以及实验室能提供哪些实验器材，找到自己合适的方向和队友，多跟老师进行沟通，会有很多指导交流的机会。当然，这门课答辩频率很高，每两周会进行一次进度汇报，每一次汇报哪些内容以及评分标准十分清晰，在Brightspace上都有展示，评分由学生及老师打分，有完整的评分表格和记录，基本能杜绝太强的个人主观性。

这个课需要用到的知识就是基本的编程，这取决于你所选的方向，个人感觉C++、Python这两个基本上就够了。
\begin{flushright}
熊俊彦； 04/07/2023
\end{flushright}
