...
\newlength{\betsubsec}
\setlength{\betsubsec}{0.02\textheight}  % 定义subsection间的空白




% 修改目录
\renewcommand{\contentsname}{\fontsize{18}{30}\bfseries\sectionfont{索引}} %名字
...
\cftsetindents{section}{0em}{1em} %改缩进
\cftsetindents{subsection}{1em}{2em}
\cftsetindents{subsubsection}{2em}{2.8em}
\cftsetindents{paragraph}{3em}{3.1em}
\cftsetindents{subparagraph}{4em}{3.4em}
